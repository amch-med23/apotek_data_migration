...
-- -----------------------------------------------------
-- Table `apotek_db`.`searchlogs`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `apotek_db`.`searchlogs` (
  `id` INT NOT NULL,
  `doctor_profile_id` INT NULL,
  `search_type` VARCHAR(45) NULL,
  `search_term` VARCHAR(45) NULL,
  `created_at` TIMESTAMP NULL,
  PRIMARY KEY (`id`),
  INDEX `doctor_profile_id_idx` (`doctor_profile_id` ASC) VISIBLE,
  CONSTRAINT `doctor_profile_id`
